...
const planBenefits = [
  {
    ...
    title: 'Export-Import Course',
    description:
      'Learn the fundamentals of international trade through recorded course content.',
  },
  {
    icon: Users,
    title: '50 Buyer Credits',
    description:
      'Access buyer opportunities through the GlobPulse platform.',
  },
  {
    icon: Briefcase,
    title: 'Business Starter Kit',
    description:
      'Get a logo, letterhead and 1-month website access for your business presence.',
  },
  {
    icon: Globe,
    title: 'GlobPulse Free Plan',
    description:
      'Get 1 year of Free Plan access to build your B2B marketplace presence.',
  },
];
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-2 font-display text-2xl sm:text-3xl font-bold text-navy-900">
            Start Your Global Business Journey
          </h2>

          <p className="mt-3 text-sm sm:text-base text-navy-500 leading-relaxed">
            Get the essential learning resources, buyer opportunities and
            business tools to start building your international presence.
          </p>
        </motion.div>
          ...
          {planBenefits.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group rounded-xl border border-navy-100 bg-white p-4 shadow-sm hover:shadow-md hover:border-gold-300 transition-all duration-300"
              >
                {/* Icon */}
